...
# JWT-based Authentication System for KI-Wissenssystem
# 
# Features:
...
class EnterpriseUserStore:
    ...
    def __init__(self):
        ...
        self.users = {
            ...
            "user@ki-wissenssystem.com": {
                "user_id": "user-001",
                "email": "user@ki-wissenssystem.com",
            ...
            "viewer@ki-wissenssystem.com": {
                "user_id": "viewer-001",
                "email": "viewer@ki-wissenssystem.com",
    ...
    def authenticate_user(self, email: str, password: str) -> Optional[Dict[str, Any]]:
        ...
        demo_passwords = {
            "admin@ki-wissenssystem.com": "admin123",
            "user@ki-wissenssystem.com": "user123",
            "viewer@ki-wissenssystem.com": "viewer123"
        }
