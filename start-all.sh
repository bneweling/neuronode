#!/bin/bash
# start-all.sh - Startet alle Neuronode Services (Backend + Frontend)
...
echo -e "${BLUE}🚀 Starte Neuronode System...${NC}"
...
echo ""
echo -e "${GREEN}🎉 Neuronode System erfolgreich gestartet!${NC}"
echo ""
...
echo "   Oder verwenden Sie das Backend CLI:"
