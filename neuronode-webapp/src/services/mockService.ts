...
export class MockAPIService implements KIWissenssystemAPI {
  ...
  // K8: Adding missing interface methods
  ...
  createWebSocketConnection(url: string): WebSocket | null {
    console.log('🔧 Mock WebSocket connection requested for:', url)
    // Return null for mock service - real connections not supported in mock
    return null
  }
} 